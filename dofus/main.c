...
int main()
{
    ...
    bouledefeu->img =load_bitmap_check("sprite.bmp");
        ...
        if (nbjoueur==4)
    {
      ...
      /*  // bouton hauts
        ...
        */
        ...
        if (zonedetect(acteur1,acteur2,acteur3,acteur4,j,150,100,ennemi)==1)//( mouse_x<=370 && mouse_x>=330 && mouse_y<=640 && mouse_y>=620)
        {
        ...
        if(( mouse_b&1 && mouse_x<=370 && mouse_x>=330 && mouse_y<=640 && mouse_y>=620)&&(zonedetect(acteur1,acteur2,acteur3,acteur4,j,150,100,ennemi)==1)&&((Joueures[j].pa-2)>=0))
        {
