...
int main()
{
    ...
    int findetous=0,fin=0,fin1=0,fin2=0,fin3=0,fin4=0,nbjoueur=0,nbfinal=0,aurevoir=0;
    int i=0,j=0;
    int ennemi=0;
      ...
      for(i=0;i<nbjoueur;)
    {
       ...
       // Bord console utilisateur
        ...
        textprintf_ex(page,font,150,95,makecol(0,255,0),0,"2 degat");//texte boutons 1
        textprintf_ex(page,font,150,245,makecol(0,255,0),0,"2 degat");//texte boutons 2
        textprintf_ex(page,font,150,395,makecol(0,255,0),0,"2 degat");//texte boutons 3
        textprintf_ex(page,font,150,545,makecol(0,255,0),0,"2 degat");//texte boutons 4

        textprintf_ex(page,font,150,110,makecol(0,255,0),0,"distance 150p");//texte boutons 1
        textprintf_ex(page,font,150,260,makecol(0,255,0),0,"distance 150p");//texte boutons 2
        textprintf_ex(page,font,150,410,makecol(0,255,0),0,"distance 150p");//texte boutons 3
        textprintf_ex(page,font,150,560,makecol(0,255,0),0,"distance 150p");//texte boutons 4
        ...
        textprintf_ex(page,font,275,95,makecol(0,255,0),0,"10 degat");//texte boutons 1
        textprintf_ex(page,font,275,245,makecol(0,255,0),0,"10 degat");//texte boutons 2
        textprintf_ex(page,font,275,395,makecol(0,255,0),0,"10 degat");//texte boutons 3
        textprintf_ex(page,font,275,545,makecol(0,255,0),0,"10 degat");//texte boutons 4

        textprintf_ex(page,font,275,110,makecol(0,255,0),0,"distance 100p");//texte boutons 1
        textprintf_ex(page,font,275,260,makecol(0,255,0),0,"distance 100p");//texte boutons 2
        textprintf_ex(page,font,275,410,makecol(0,255,0),0,"distance 100p");//texte boutons 3
        textprintf_ex(page,font,275,560,makecol(0,255,0),0,"distance 100p");//texte boutons 4
        ...
        textprintf_ex(page,font,400,95,makecol(0,255,0),0,"50 degat");//texte boutons 1
        textprintf_ex(page,font,400,245,makecol(0,255,0),0,"50 degat");//texte boutons 2
        textprintf_ex(page,font,400,395,makecol(0,255,0),0,"50 degat");//texte boutons 3
        textprintf_ex(page,font,400,545,makecol(0,255,0),0,"50 degat");//texte boutons 4

        textprintf_ex(page,font,400,110,makecol(0,255,0),0,"distance 50p");//texte boutons 1
        textprintf_ex(page,font,400,260,makecol(0,255,0),0,"distance 50p");//texte boutons 2
        textprintf_ex(page,font,400,410,makecol(0,255,0),0,"distance 50p");//texte boutons 3
        textprintf_ex(page,font,400,560,makecol(0,255,0),0,"distance 50p");//texte boutons 4
        ...
        textprintf_ex(page,font,525,95,makecol(0,255,0),0,"augmente pv 10");//texte boutons 1
        textprintf_ex(page,font,525,245,makecol(0,255,0),0,"augmente pv 10");//texte boutons 2
        textprintf_ex(page,font,525,395,makecol(0,255,0),0,"augmente pv 10");//texte boutons 3
        textprintf_ex(page,font,525,545,makecol(0,255,0),0,"augmente pv 10");//texte boutons 4
        ...
        textprintf_ex(page,font,650,110,makecol(0,255,0),0,"distance 32p");//texte boutons 1
        textprintf_ex(page,font,650,260,makecol(0,255,0),0,"distance 32p");//texte boutons 2
        textprintf_ex(page,font,650,410,makecol(0,255,0),0,"distance 32p");//texte boutons 3
        textprintf_ex(page,font,650,560,makecol(0,255,0),0,"distance 32p");//texte boutons 4
    ...
    if((j==0)&&(Joueures[j].pm>0))
    {
        ...
        int isNewCheminDisponible = calculerNewChemin(tabChemin, terrain ,typeTuiles, tuileJoueur, tuileSouris, Joueures[j].pm);    //renvoie le nombre de déplacements (nombre de tuile à parcourir)
        ...
        if(isNewCheminDisponible != -1){
            ...
            if(mouse_b & 1){    //si on clique sur la souris
                ...
                Joueures[j].pm=Joueures[j].pm-isNewCheminDisponible;//enlever isNewCheminDisponible à la PM du joueur
            }
        ...
        if (nbjoueur==4)
    {
      ...
      /*  // bouton hauts
        ...
        */
        ...
        if(zonedetect(acteur1,acteur2,acteur3,acteur4,j,32,0,ennemi)==1)//( mouse_x<=420 && mouse_x>=380 && mouse_y<=620 && mouse_y>=600)
        {
        ...
        if(( mouse_b&1 && mouse_x<=420 && mouse_x>=380 && mouse_y<=620 && mouse_y>=600)&&(zonedetect(acteur1,acteur2,acteur3,acteur4,j,32,0,ennemi)==1)&&((Joueures[j].pa-2)>=0))
        {
            nbjoueur=Arme(Joueures[j].classe,j,ennemi,nbjoueur);
        }


        // bouton attaque à distance 1

        if (zonedetect(acteur1,acteur2,acteur3,acteur4,j,150,0,ennemi)==1)//( mouse_x<=370 && mouse_x>=330 && mouse_y<=640 && mouse_y>=620)
        {
        ...
        if(( mouse_b&1 && mouse_x<=370 && mouse_x>=330 && mouse_y<=640 && mouse_y>=620)&&(zonedetect(acteur1,acteur2,acteur3,acteur4,j,150,0,ennemi)==1)&&((Joueures[j].pa-2)>=0))
        {
            nbjoueur=Sort1(Joueures[j].classe,j,ennemi,nbjoueur);
        }
        ...
        if(zonedetect(acteur1,acteur2,acteur3,acteur4,j,100,0,ennemi)==1)//( mouse_x<=470 && mouse_x>=430 && mouse_y<=640 && mouse_y>=620)
        {
        ...
        if(( mouse_b&1 && mouse_x<=470 && mouse_x>=430 && mouse_y<=640 && mouse_y>=620)&&(zonedetect(acteur1,acteur2,acteur3,acteur4,j,100,0,ennemi)==1)&&((Joueures[j].pa-2)>=0))
        {
           nbjoueur=Sort2(Joueures[j].classe,j,ennemi,nbjoueur);
        }


        // bouton attaque à distance 3

        if(zonedetect(acteur1,acteur2,acteur3,acteur4,j,50,0,ennemi)==1)//( mouse_x<=370 && mouse_x>=330 && mouse_y<=680 && mouse_y>=660)
        {
        ...
        if(( mouse_b&1 && mouse_x<=370 && mouse_x>=330 && mouse_y<=680 && mouse_y>=660)&&(zonedetect(acteur1,acteur2,acteur3,acteur4,j,50,0,ennemi)==1)&&((Joueures[j].pa-2)>=0))
        {
            nbjoueur=Sort3(Joueures[j].classe,j,ennemi,nbjoueur);
        }
        ...
        {
            nbjoueur=Sort4(Joueures[j].classe,j,ennemi,nbjoueur);
        }
